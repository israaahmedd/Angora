...
var body =document.body;
var modal = document.getElementById("modal");
var addNewTask= document.getElementById("newTask"); // page1
var statusInput = document.getElementById("status");
var categoryInput = document.getElementById("category");
var titleInput = document.getElementById("title");
var descriptionInput = document.getElementById("description");
var addBtn = document.getElementById("addBtn");// page2
...
var gridBtn = document.getElementById("gridBtn");// mrba3at
var barsBtn = document.getElementById("barsBtn"); // list
...
function displayTasks(index){
 ...
 <li><i class="fa-sharp fa-solid fa-trash" onclick="deleteTask(${index})"></i></li>
 <li><i class="fa-sharp fa-solid fa-palette" onclick="changColor(${index})"></i></i></li>
</ul>
</div>`;
...
categoryInput.valu= tasksArr[index].category;
